    ...
    <form onSubmit={handleSubmit} className={`space-y-5 ${className}`}>
      ...
      <div className="pt-2">
        <button
          ...
          className="w-full py-3 text-sm font-black text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-lg shadow-indigo-100 dark:shadow-none transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isLoading ? (
            <>
